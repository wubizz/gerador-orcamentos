...
def call_ollama(prompt, model="llama3.2"):
    """Faz a chamada para o modelo de IA rodando na sua máquina."""
    ...
    try:
        ...
        raise Exception(f"Erro Ollama ({res.status_code}): {res.text}")
    except Exception as e:
        raise Exception(f"Erro ao conectar com Ollama Local: {str(e)}")
